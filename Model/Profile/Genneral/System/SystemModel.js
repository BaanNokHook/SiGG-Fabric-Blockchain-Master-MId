...
class SystemModel {
    ...
    GetSystemName (log, callback) {
        ...
        Schema.SystemSchema.aggregate(query, function(err, result) {
    ...
    Insert (dataItem, log, callback) {
        ...
        let schema = new Schema.SystemSchema();

        schema.SYSTEM_ID = schema.id;
        schema.SYSTEM_NAME = dataItem.SYSTEM_NAME;
    ...
    Update (dataItem, log, callback) {
        ...
        Schema.SystemSchema.findOneAndUpdate({ SYSTEM_ID: dataItem.SYSTEM_ID }, { $set: schema }, function(err) {
